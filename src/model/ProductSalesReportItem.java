...
public class ProductSalesReportItem {
    ...
    public ProductSalesReportItem(String getProductLine, String productVendor, String productCode, String productName, int quantityOrdered, double priceEach, String orderStatus, String orderFromCity) {
